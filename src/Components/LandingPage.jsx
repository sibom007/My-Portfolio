    ...
    return (
        <div data-scroll data-scroll-speed='-.1' className="w-full ">
            <div className="pt-32 md:flex items-center justify-between gap-10 md:px-32">
                ...
                <div className="uppercasec text-[5vw] md:text-[4vw] font-semibold md:leading-[5vw] lg:leading-[4vw] flex-1"><p>Hello EveryOne <br /> How Are you I Think You Are Alse Fine <br />Welcome My PortPolio Site</p></div>
            </div>
